...
```text
13501b045aae7fc4b22065e4f62f3616acb4ba8f
```
...
**Level 1C : lots 1C-0, 1C-1, 1C-3a, 1C-3b, 1C-4a, 1C-4b, 1C-4c, 1C-5a, 1C-5b, 1C-6a, 1C-6b acceptés définitivement** (commits respectifs cités dans leurs sections dédiées ci-dessous ; 1C-4b, 1C-5a, 1C-6a, 1C-6b sont des audits de lecture seule sans commit propre). **1C-2a/1C-2b/1C-2c** : voir la section dédiée ci-dessous — statut corrigé (1C-2b/1C-2c seuls acceptés définitivement en tant que jalons ; 1C-2a suspendu puis subsumé, jamais accepté séparément). **1C-6c** (pré-enregistrement documentaire du design de campagne `J0` et de la stratégie baseline/tracking, ce commit) clôture documentairement 1C-6a/1C-6b — voir « Lot 1C-6a », « Lot 1C-6b » et « Lot 1C-6c » ci-dessous.
