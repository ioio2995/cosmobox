...
```text
a2dd016a4dbb035782340667b15fc35c6aa19e46
```
...
**Level 1C : lots 1C-0, 1C-1, 1C-3a, 1C-3b, 1C-4a, 1C-4b, 1C-4c, 1C-5a, 1C-5b, 1C-6a, 1C-6b, 1C-6d acceptés définitivement** (commits respectifs cités dans leurs sections dédiées ci-dessous ; 1C-4b, 1C-5a, 1C-6a, 1C-6b, 1C-6d sont des audits de lecture seule sans commit propre). **1C-2a/1C-2b/1C-2c** : voir la section dédiée ci-dessous — statut corrigé (1C-2b/1C-2c seuls acceptés définitivement en tant que jalons ; 1C-2a suspendu puis subsumé, jamais accepté séparément). **Housekeeping `.gitignore`** (`chore: ignore generated results`, commit `a2dd016a4dbb035782340667b15fc35c6aa19e46`) : intègre l'ignorance de `results/` comme politique permanente du dépôt, n'est plus une exception locale. **1C-6e** (pré-enregistrement documentaire du gel de `δ`, de la grille `J0`, et du contrat de préflight, ce commit) clôture documentairement 1C-6d — voir « Lot 1C-6d » et « Lot 1C-6e » ci-dessous.
