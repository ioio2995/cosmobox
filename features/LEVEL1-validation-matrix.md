# Matrice de validation — niveau 1B

| ID | Exigence | Cas minimal | Type | Tolérance |
|---|---|---|---|---:|
| V01 | Commutation avec Gauss | triangle, chemin direct | analytique + matrice | 1e-10 |
| V02 | Arête parcourue en sens inverse | chemin contenant \(U^\dagger\) | exact | 1e-10 |
| V03 | Relation d’adjoint | \(P\) et \(P^{-1}\) | exact | 1e-10 |
...
| V07 | Réduction du groupe de symétrie | contrôle `j_break` | logique + matrice | 1e-10 |
